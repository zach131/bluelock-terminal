  ...
  return (
    <main style={styles.main}>
      <header style={styles.header}>
        <div style={styles.headerTitle}>CORE_09: CHESSBOARD</div>
        <div style={styles.headerSubtitle}>SOCIAL HIERARCHY MAP</div>
      </header>
      ...
      <div style={styles.content}>
        <div style={styles.card}>
          ...
          <p style={styles.text}>
            Mapping key relationships, allies, rivals, and social influence.
          </p>
          <div style={styles.placeholderBox}>
            <span style={styles.placeholderText}>RELATIONSHIP MATRIX</span>
          </div>
        </div>
      </div>
...
const styles: { [key: string]: React.CSSProperties } = {
  ...
  header: { padding: '1rem', textAlign: 'center', borderBottom: '1px solid #FFAB00', backgroundColor: '#0A0A0A' },
  headerTitle: { fontSize: '0.9rem', fontWeight: 'bold', color: '#FFAB00', letterSpacing: '0.2em' },
