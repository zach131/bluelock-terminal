  ...
  return (
    <main style={styles.main}>
      <header style={styles.header}>
        <div style={styles.headerTitle}>CORE_07: NEURAL LINK</div>
        <div style={styles.headerSubtitle}>PSYCHOLOGICAL EXTRACTION</div>
      </header>
      ...
      <div style={styles.content}>
        <div style={styles.card}>
          ...
          <p style={styles.text}>
            Extracting wisdom from anime/media and mapping psychological concepts.
          </p>
          <div style={styles.placeholderBox}>
            <span style={styles.placeholderText}>WISDOM DATABASE / MIND MAP</span>
          </div>
        </div>
      </div>
...
const styles: { [key: string]: React.CSSProperties } = {
  ...
  header: { padding: '1rem', textAlign: 'center', borderBottom: '1px solid #651FFF', backgroundColor: '#0A0A0A' },
  headerTitle: { fontSize: '0.9rem', fontWeight: 'bold', color: '#651FFF', letterSpacing: '0.2em' },
